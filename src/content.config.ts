...
const businesses = defineCollection({
  ...
  schema: z.object({
    ...
    category: z.enum(['eat', 'stay', 'dive', 'shop', 'transport', 'health', 'services', 'recreation']),
    categories: z.array(z.enum(['eat', 'stay', 'dive', 'shop', 'transport', 'health', 'services', 'recreation'])).min(1),
    barangay,
    address: z.string(),

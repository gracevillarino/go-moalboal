---
title: A town written in water
slug: a-town-written-in-water
summary: The story of Moalboal begins with a name, a spring, a coastline and institutions shaped by life beside the sea.
type: history
...
status: published
sources:
  - title: Brief history of Moalboal
    publisher: Municipality of Moalboal
    url: https://moalboalcebu.gov.ph/brief-history-of-moalboal/
  - title: About Moalboal
    publisher: Municipality of Moalboal
    url: https://moalboalcebu.gov.ph/about-moalboal/
  - title: Municipality of Moalboal — barangays
    publisher: Philippine Statistics Authority
    url: https://psa.gov.ph/classification/psgc/barangays/0702233000
  - title: 2020 Census of Population and Housing, Report No. 4
    publisher: Philippine Statistics Authority
    url: https://psa.gov.ph/system/files/main-publication/1_2020%2520CPH%2520Report%2520No.%25204_26April2023_RRDH_CRD-signed.pdf
  - title: Campus History — CTU Moalboal
    publisher: Cebu Technological University
    url: https://www.ctu.edu.ph/moalboal/about/campus-history/
...
Visitors often meet Moalboal through its western coastline, but the municipality is not a single tourism district. The [Philippine Statistics Authority’s geographic classification](https://psa.gov.ph/classification/psgc/barangays/0702233000) lists its barangays as the basic civic geography of the town. Poblacion, Basdiot and Saavedra may appear frequently in visitor itineraries, yet the social life of Moalboal stretches inland and across agricultural, residential, institutional and coastal spaces.

The numbers also show a community growing across generations. The PSA’s [2020 census reporting](https://psa.gov.ph/system/files/main-publication/1_2020%2520CPH%2520Report%2520No.%25204_26April2023_RRDH_CRD-signed.pdf) counted 36,930 people in Moalboal. A population count is not a portrait, but it helps correct the idea that the town is only the people a traveller encounters along Panagsama.
...
One of the clearest institutional threads runs through what is now Cebu Technological University’s Moalboal campus. The university’s [campus history](https://www.ctu.edu.ph/moalboal/about/campus-history/) traces its beginning to a municipal resolution in 1947 and the opening of Moalboal Provincial High School in a modest structure the following year.

In 1963, [Republic Act No. 3613](https://issuances-library.senate.gov.ph/legislative-issuance/republic-act-no-3613) converted the provincial high school into the Moalboal Southern Cebu School of Fisheries. The name matters. It formally connected education to the knowledge, work and economy of a coastal community. The institution later expanded into technical, teacher-training, engineering, hospitality and other programs, but fisheries remained part of its lineage.

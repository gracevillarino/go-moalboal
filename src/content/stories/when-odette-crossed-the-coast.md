---
title: When Odette crossed the coast
slug: when-odette-crossed-the-coast
summary: The record of Typhoon Odette in Moalboal is written in damaged homes, a battered pier, changed reefs and the long work after landfall.
type: community
readingMinutes: 7
featured: false
...
status: published
sources:
  - title: Field Survey of 2021 Typhoon Rai — Odette — in the Philippines
    publisher: UCL Discovery / Journal of Coastal and Riverine Flood Risk
    url: https://discovery.ucl.ac.uk/id/eprint/10169127/
  - title: Field Survey of 2021 Typhoon Rai — full article
    publisher: Journal of Coastal and Riverine Flood Risk
    url: https://journals.open.tudelft.nl/jcrfr/article/view/6717/5570
  - title: Situational Report for Tropical Cyclone Odette 2021
    publisher: National Disaster Risk Reduction and Management Council
    url: https://ndrrmc.gov.ph/attachments/article/4174/SitRep_No_42_for_Typhoon_ODETTE_2021.pdf
  - title: Terminal Report on Typhoon Odette
    publisher: Department of Social Welfare and Development — DROMIC
    url: https://dromic.dswd.gov.ph/wp-content/uploads/2026/03/DSWD-DROMIC-Terminal-Report-on-Typhoon-ODETTE-05-March-2026-6PM.pdf
  - title: Regional State of the Brown Environment Report 2021
    publisher: Environmental Management Bureau Region VII
    url: https://r7.emb.gov.ph/wp-content/uploads/2022/10/R7_RSOBE-Report-2021-signed.pdf
...
A post-event [field survey](https://discovery.ucl.ac.uk/id/eprint/10169127/) visited coastal areas across the Visayas. In Moalboal, researchers documented damage at the town port and gathered an eyewitness account from a coast guard member who had been evacuating fishers. The [full study](https://journals.open.tudelft.nl/jcrfr/article/view/6717/5570) describes water and waves overtopping the pier and inundating houses behind it.

## A disaster has several maps

The physical map shows wind, water level, wave action and damaged structures. Government situation reports create an administrative map of affected people, evacuations, infrastructure and response. The [NDRRMC report](https://ndrrmc.gov.ph/attachments/article/4174/SitRep_No_42_for_Typhoon_ODETTE_2021.pdf) places Moalboal within the much larger footprint of the disaster across the Philippines.

The [DSWD’s terminal report](https://dromic.dswd.gov.ph/wp-content/uploads/2026/03/DSWD-DROMIC-Terminal-Report-on-Typhoon-ODETTE-05-March-2026-6PM.pdf) adds a later accounting of damaged houses and assistance. These datasets matter, but they compress different experiences into rows. A partially damaged home can still mean months of leaks, debt and interrupted work. A repaired tourism business does not necessarily mean every worker recovered at the same pace.

There is also an ecological map. The storm’s force reached shallow coastal habitat and reefs. Baseline and follow-up monitoring become essential after such an event because casual observation can confuse visible change with overall condition. The Environmental Management Bureau’s [regional environmental report](https://r7.emb.gov.ph/wp-content/uploads/2022/10/R7_RSOBE-Report-2021-signed.pdf) includes monitoring information for Moalboal’s coastal waters, part of the wider record needed to understand cumulative pressures.

## Recovery is not a reopening date

Tourism statistics often use arrivals, occupancy or business operation to measure recovery. A [Philippine Information Agency report](https://pia.gov.ph/news/visayas/cv-visayas/central-visayas-tourism-industry-logs-80-recovery-rate/) described the broader Central Visayas industry’s rebound relative to pre-pandemic activity.
